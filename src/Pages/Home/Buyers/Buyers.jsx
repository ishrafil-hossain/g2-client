                ...
                <div className="customContainer">
                    <div className="hero-content flex-col lg:flex-row">
                        <div>
                            ...
                            <p className='text-black py-5 lg:text-xl text-center lg:text-start'>Your future customers are researching their next purchase on G2. Make sure they can find you.</p>
